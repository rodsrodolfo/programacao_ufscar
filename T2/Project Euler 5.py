...
for a in range (21): #loop que testa os possiveis divisores primos dos números de 1 a 20 e os adiciona na lista p
    if prime(a):
        p.append(a)
...
for a in range(1,21):  #esse loop fatora os números de 1 a 20 e armazena os dados no dicionário
    c=a
    f[a]={}
    for b in p:
        f[a][b]=0
